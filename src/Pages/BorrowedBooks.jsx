            ...
            <p className="text-center  text-xs md:text-lg lg:text-lg max-w-2xl mx-auto mt-2 mb-3 font-sedan" >Go Beyond The Limit By Exploring Specific Category</p>
            {
                loadedBooks.length <= 0 ?
                    <div className=" flex justify-center items-center h-60">
                        <p className="text-center  text-xs md:text-lg lg:text-lg max-w-2xl mx-auto mt-2 mb-3 font-sedan font-extrabold" >You Have Not Borrowed Any Book Yet...</p>
                            ...
                            loadedBooks.map(book => <div key={book._id} className="flex max-w-md flex-col justify-center items-center md:flex-row lg:flex-row overflow-hidden bg-white rounded-lg shadow-lg p-3">
                                ...
                                <div className="md:w-2/3 lg:w-2/3 h-fit p-4 md:p-4 text-center md:text-left lg:text-left">
                                    ...
                                    <div className="flex flex-col mt-3 ">
                                        <h1 className="text-sm mt-2 font-normal text-gray-800"> <span className="font-medium ">Borrowed Date : <span className="font-normal">{book.borrowed_date}</span></span></h1>
                                        <h1 className="text-xs md:text-xs lg:text-sm mt-2 font-normal text-gray-800"> <span className="font-medium">Return Date : </span >{book.returnDate}</h1>
                                    </div>
