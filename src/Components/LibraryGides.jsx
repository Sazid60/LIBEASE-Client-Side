...
const LibraryGides = () => {
    return (
        ...
        <div className="mt-6 font-sedan">
            ...
            <div className="flex flex-col md:flex-col lg:flex-row  justify-center md:justify-center lg:justify-between items-center ">
                <div className="lg:w-[60%]">
                    <img src="https://i.postimg.cc/rwfKXMb6/model-com.jpg" className="rounded-xl " alt="" />
    
                </div>
                <div className="md:w-full lg:w-[40%] dark:divide-gray-300 ">
                    <div className="flex flex-col justify-start p-2 md:p-2 lg:p-6 divide-y lg:col-span-6 dark:divide-gray-300 text-center">
                        <div className="space-y-2 mb-2 lg:mb-3 ">

                            <h1 className="text-lg md:text-xl lg:text-3xl font-bold">Borrow, Reserve, Renew</h1>
                            <p className="text-xs md:text-sm lg:text-sm ">Get advanced research assistance in dozens of subject areas.</p>

                        </div>
                        <div className="space-y-2 mb-2 lg:mb-3">

                            <h1 className="text-lg md:text-xl lg:text-3xl font-bold">Study Spaces & PCs</h1>
                            <p className="text-xs md:text-sm lg:text-sm">Deposit data, papers, and other resources for long-term access.</p>
                        </div>
                        <div className=" space-y-2 mb-2 lg:mb-3">
                            <h1 className="text-lg md:text-xl lg:text-3xl font-bold">Library Guides</h1>
